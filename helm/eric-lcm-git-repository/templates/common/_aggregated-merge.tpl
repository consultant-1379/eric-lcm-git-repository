...
*/ -}}
{{- define "eric-lcm-git-repository.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-lcm-git-repository.mergeAnnotations" -}}
  {{- include "eric-lcm-git-repository.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-lcm-git-repository.mergeLabels" -}}
  {{- include "eric-lcm-git-repository.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
